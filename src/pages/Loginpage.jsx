  ...
  return (
    <div className='h-[100vh] bg-slate-950'>
      ...
      <div>
           ...
           <h1 className='text-center text-3xl mt-2 font-bold underline text-white'>User-Login</h1>
                   </div>
                   <div className=' card-body'>
                    <form action="/login">
                        <div className=' flex gap-3'><IoMdMail className='text-white  text-[40px] '/><input type="email" placeholder='Enter the Email-Id' className=' form-control p-2 w-full rounded-md placeholder:text-center placeholder:font-bold placeholder:text-slate-600' required/></div>  
                        ...
                        <div className='flex gap-2 mt-2'><p className='text-white font-semibold text-center'>don't have an Account? Click Here <a href="/register" className=' text-green-400 underline'>Register</a></p></div>
